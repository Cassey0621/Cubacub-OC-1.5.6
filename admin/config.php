<?php
// HTTP
define('HTTP_SERVER', 'https://yourwebsite.tld/admin/');
define('HTTP_CATALOG', 'https://yourwebsite.tld/');

// HTTPS
define('HTTPS_SERVER', 'https://yourwebsite.tld/admin/');
define('HTTPS_CATALOG', 'https://yourwebsite.tld/');

// DIR
define('DIR_APPLICATION', '/home/username/public_html/admin/');
define('DIR_SYSTEM', '/home/username/public_html/system/');
define('DIR_DATABASE', '/home/username/public_html/system/database/');

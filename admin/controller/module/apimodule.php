...
class ControllerModuleApimodule extends Controller {
    ...
    public function index() {
        ...
        $this->data['action'] = $this->url->link('module/apimodule', 'token=' . $this->session->data['token'], 'SSL');

        $this->data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');

        if (isset($this->request->post['apimodule_status'])) {
            $this->data['apimodule_status'] = $this->request->post['apimodule_status'];
        } else {
            $this->data['apimodule_status'] = $this->config->get('apimodule_status');
        }
        ...
        if (!extension_loaded('zip')) {
            $this->data['ext'] = "not installed zip extension for update";
        }else{
            $this->data['ext'] = "";
        }
        ...
        $this->template = 'module/apimodule.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );

        $this->data['version'] = $version = $this->checkVersion();
        $this->data['update'] = $this->url->link('extension/module/apimodule/update&v='.$version, 'token=' . $this->session->data['token'], 'SSL');
